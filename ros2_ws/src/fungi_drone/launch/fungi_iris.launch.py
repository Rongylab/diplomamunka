...
def generate_launch_description():
    ...
    pkg_fungi_drone = get_package_share_directory("fungi_drone")
        ...
        parameters=[
            {
                "config_file": os.path.join(
                    pkg_fungi_drone, "config", "iris_lidar_bridge.yaml" # pkg_fungi_drone, "config", "fungi_iris_bridge.yaml" pkg_project_bringup
                ),
